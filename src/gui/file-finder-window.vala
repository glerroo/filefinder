...
public class FileFinderWindow : Adw.ApplicationWindow {
    ...
    protected void build () {
        ...
        tv = new Adw.ToolbarView ();
        this.set_content (tv);

        hb = new Adw.HeaderBar ();
        wt = new Adw.WindowTitle (Text.app_name, "");
        ...
        // Toast Menu
        mmenu = new GLib.Menu ();
        mmenu.append ("Preferences", "app.preferences");
        mmenu.append ("About", "app.about");

        Gtk.PopoverMenu pmenu = new Gtk.PopoverMenu.from_model (mmenu);
        ...
        button_menu.set_icon_name ("open-menu-symbolic");
        // button_menu.menu_model = (mmenu as MenuModel);
        // button_menu.set_popup (mmenu);


        button_menu.set_popover (pmenu);
        ...
        button_go.add_css_class ("suggested-action");
        ...
        Gtk.PopoverMenu ppmenu = new Gtk.PopoverMenu.from_model (menu);
